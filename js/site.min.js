!function (t) {
    ...
    t(".btn-group .btn").click(function () {
        var e = t("input", this), a = e.attr("id");
    ...
    var t = new Clipboard(".btn-clipboard", {
        text: function (t) {
            var e = $(t), a = $(t.parentNode.nextElementSibling), s = url = a.text();
    ...
    t.on("success", function (t) {
        ...
        var e = /Mac/i.test(navigator.userAgent) ? "⌘" : "Ctrl-", a = "Press " + e + "C to copy";
